...
-- Token: UNI (0x1f9840a85d5af5bf1d1762f925bdaddc4201f984, 18 decimals)

WITH
-- ============================================================
-- Step 1: compute CURRENT balance for every address that ever held UNI
-- ============================================================
all_balances AS (
...
-- ============================================================
-- Step 2: build activity timestamps per address
-- ============================================================
activity AS (
    SELECT
        wallet,
