...
df = pd.read_csv(DATA_DIR / "09_timeseries_uni.csv")
...
ax.set_title(
    "UNI — active-holder Gini coefficient over time\nby activity window",
    fontsize=12, pad=12,
)
...
plt.tight_layout()
plt.savefig(CHARTS_DIR / "09_uni_gini_over_time.png", dpi=160, bbox_inches="tight")
