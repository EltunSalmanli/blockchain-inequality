...
df = pd.read_csv(DATA_DIR / "08_timeseries_aave.csv")
...
ax.set_title(
    "AAVE — active-holder Gini coefficient over time\nby activity window",
    fontsize=12, pad=12,
)
...
plt.tight_layout()
plt.savefig(CHARTS_DIR / "08_aave_gini_over_time.png", dpi=160, bbox_inches="tight")
